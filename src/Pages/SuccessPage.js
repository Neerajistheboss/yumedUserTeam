...
const SuccessPage = () => {
    ...
    return ( <
        ...
        h2 > Thank you
        for Choosing Us! < /h2> <
        button className = "border rounded m-3 "
        style = {
            { backgroundColor: "#1B1B30", color: "white" }
        } > See Appointment Details < /button> <
        h3 > YuMedic < /h3> <
        ...
        /> < /
        div > <
        button className = "border rounded m-3 anotherAppointment" > Book Another Appointment < /button> < /
        div >
    )
