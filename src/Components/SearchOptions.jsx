	...
	return (
		...
		<div className='section'>
			...
			<div className="searchDoctor container my-5">
				<h3 style={{ fontWeight: 'bold', fontsize: '2.5rem !important' }}> Search for Doctors </h3>

				<div class='my-3'>
					<div class='row  w-100' id="form row" >
						<div className=' mb-md-1  col-12 col-sm-4 px-5 px-sm-1 text-danger' style={{}}>
							<input
								style={{ margin: "3px auto", padding: '3px' }}
								name='name'
						...
						<div className=' col-5 col-sm-4 col-md-2' >
							<NavLink id="searchBtn" to='search' className='text-decoration-none searchoption  text-center d-inline-block pt-2 ' style={{ color: "white", fontSize: '20px', backgroundColor: '#BD0F40', margin: "3px auto" }} onClick={() => setSearchFields(search)}>
